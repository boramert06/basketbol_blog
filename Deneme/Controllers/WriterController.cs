...
namespace Deneme.Controllers
{
    ...
    public class WriterController : Controller
    {
        ...
        public IActionResult WriterEditProfile()
        {
            ...
            var about = context.Users.Where(x => x.UserName == username).Select(y => y.UserAbout).FirstOrDefault();
            var phone = context.Users.Where(x => x.UserName == username).Select(y => y.UserPhone).FirstOrDefault();
